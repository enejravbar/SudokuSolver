...
function preveriVeljavnostSudokuja(){
	...
	for(var i=0; i<9;i++){
		for(var j= 0; j<9; j++){
			element=document.getElementById("P"+i+"_"+j);
			if(element.value==""){stevecPraznihPolj++;}
...
function izrisiPlosco(){
	...
	for(var i=0; i<9; i++){
		...
		for(var j=0; j<9; j++){			// posamezno polje ima id stVrstice_stStolpca
			if((j==2 || j==5) && (i==2 || i==5)){
				niz += "<td class=\"polje\" id=\"O"+i+"_"+j+"\"  style=\"background-color:grey; border-right: solid;border-bottom: solid;\"> <input id=\"P"+i+"_"+j+"\" maxlength=\"1\" style=\" width:46px; height:46px; background-color:white; text-align:center; font-size:20px; font-weight:bold; \"type=\"text\"></td>";
			}else{
				if(j==2 || j==5){
					niz += "<td class=\"polje\" id=\"O"+i+"_"+j+"\"  style=\"background-color:grey; border-right: solid;\"> <input id=\"P"+i+"_"+j+"\" maxlength=\"1\" style=\" width:46px; height:46px; background-color:white; text-align:center; font-size:20px; font-weight:bold; \"type=\"text\"></td>";
				}else{
					if(i==2 || i==5){
						niz += "<td class=\"polje\" id=\"O"+i+"_"+j+"\"  style=\"background-color:grey; border-bottom: solid;\"> <input id=\"P"+i+"_"+j+"\" maxlength=\"1\" style=\" width:46px; height:46px; background-color:white; text-align:center; font-size:20px; font-weight:bold; \"type=\"text\"></td>";
					}else{
						niz += "<td class=\"polje\" id=\"O"+i+"_"+j+"\"  style=\"background-color:grey; \"> <input id=\"P"+i+"_"+j+"\" maxlength=\"1\" style=\" width:46px; height:46px; background-color:white; text-align:center; font-size:20px; font-weight:bold;\"type=\"text\"></td>";
					}
